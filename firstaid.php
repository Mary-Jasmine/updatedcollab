...
<body>
    ...
    <?php include 'sidebar.php'; ?>
       ...
       <div class="content">
            ...
            <h2 class="section-title">Emergency Kit Checklist</h2>
            <p class="section-description">Ensure your emergency kit is fully stocked and ready. Mark items as you acquire them.</p>
            ...
            <div class="checklist-section">
                <div class="checklist-item">
                    <div class="checklist-title">
                        ...
                        <div class="checklist-text">Basic First Aid Kit</div>
                    </div>
                 <details>
                    <summary></summary>
                    <label>
                     <input type="checkbox"   class="checkbox"> Bandages
                    </label>        
                    <br>
                    <label> 
                     <input type="checkbox"  class="checkbox"> Antiseptic Wipes
                    </label>    
                    <br>
                    <label>
                     <input type="checkbox"  class="checkbox"> Gauze
                    </label>
                    <br>
                    <label>
                     <input type="checkbox"  class="checkbox"> Medical Tape
                    </label>
                    <br>
                    <label>
                     <input type="checkbox"  class="checkbox"> Pain Relievers
                    </label>
                    <br>
                    <label>
                     <input type="checkbox"  class="checkbox"> Scissors
                    </label>
                 </details>
                </div>
                <div class="checklist-description" style="margin-left: 30px; margin-bottom: 15px;">Includes bandages, antiseptic wipes, gauze, medical tape, pain relievers, and scissors. Essential for minor injuries.</div>

                <div class="checklist-item">
                    <div class="checklist-title">
                       <input type="checkbox" class="checkbox">
                        <div class="checklist-text">Water (1 gallon per person per day for 3 days)</div>
                    </div>
                   
                </div>
                <div class="checklist-description" style="margin-left: 30px; margin-bottom: 15px;">Crucial for drinking and sanitation. Store in a cool, dark place.</div>

                <div class="checklist-item">
                    <div class="checklist-title">
                        <input type="checkbox" class="checkbox">
                      
                        <div class="checklist-text">Non-perishable Food (3-day supply)</div>
                    </div>
                ...
                <div class="checklist-item">
                    <div class="checklist-title">
                        ...
                        <div class="checklist-text">Battery-powered or Hand Crank Radio</div>
                    </div>
                <details>
                    <summary></summary>
                    <label>
                     <input type="checkbox"   class="checkbox"> Battery-powered
                    </label>
                    <br>
                    <label>
                     <input type="checkbox"  class="checkbox"> Hand Crank Radio
                    </label>
                </details>
                </div>
                ...
                <div class="checklist-item">
                    <div class="checklist-title">
                        ...
                        <div class="checklist-text">Flashlight and Extra Batteries</div>
                    </div>
              <details>
                <summary></summary>
                    <label>
                     <input type="checkbox"   class="checkbox"> Flashlight
                    </label>
                    <br>
                    <label>
                     <input type="checkbox"  class="checkbox"> Extra Batteries
                    </label>
              </details>
                </div>
                ...
                <div class="checklist-item">
                    <div class="checklist-title">
                        ...
                        <div class="checklist-text">Whistle</div>
                    </div>
                ...
                <div class="checklist-item">
                    <div class="checklist-title">
                        ...
                        <div class="checklist-text">Dust Mask</div>
                    </div>
                ...
                <div class="checklist-item">
                    <div class="checklist-title">
                        ...
                        <div class="checklist-text">Moist Towelettes, Garbage Bags, and Plastic Ties</div>
                    </div>
                  <details>
                    <summary></summary>
                    <label>
                     <input type="checkbox"   class="checkbox"> Moist Towelettes
                    </label>
                    <br>
                    <label>
                     <input type="checkbox"  class="checkbox"> Garbage Bags
                    </label>
                    <br>
                    <label>
                     <input type="checkbox"  class="checkbox"> Plastic Ties
                    </label>
                  </details>
                ...
                <div class="checklist-item">
                    <div class="checklist-title">
                        ...
                        <div class="checklist-text">Wrench or Pliers</div>
                    </div>
                ...
                <div class="checklist-item">
                    <div class="checklist-title">
                        ...
                        <div class="checklist-text">Manual Can Opener</div>
                    </div>
                ...
                <div class="checklist-item">
                    <div class="checklist-title">
                        ...
                        <div class="checklist-text">Local Maps</div>
                    </div>
                ...
                <div class="checklist-item">
                    <div class="checklist-title">
                        ...
                        <div class="checklist-text">Cell phone with chargers and a backup battery</div>
                    </div>
