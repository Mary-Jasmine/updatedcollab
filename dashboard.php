...
try {
    ...
    // average resolution time (seconds -> days)
    ...
    // keep stats as defaults if something goes wrong
    error_log("Stats query error: " . $e->getMessage());
}

// -------------------------------------------------
// 2) Trends: build last 12 months array (server side)
// -------------------------------------------------
$months = [];
for ($i = 11; $i >= 0; $i--) {
...
// -------------------------------------------------
// 3) Incident types (for donut & top5)
// -------------------------------------------------
$types = [];
try {
...
// -------------------------------------------------
// 4) Incidents by barangay (bar chart) — try barangay_stats then fallback
// -------------------------------------------------
$barangays = [];
try {
...
// For templates below: convert PHP arrays to JSON safely for charts
...
body,html { margin:0; padding:0; font-family:"Segoe UI",Tahoma,Geneva,Verdana,sans-serif;
    ...
    .container { flex:1; max-width:1500px; width:1005%; margin:0 auto; }
...
<div class="container">
    ...
    <div class="controls" role="region" aria-label="dashboard controls">
        <div class="left">
            ...
            <button class="btn-primary" id="btnReport">Report an Incident</button>
        </div>
